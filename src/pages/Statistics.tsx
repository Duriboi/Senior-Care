  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500 pb-12">
      <section className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button className="bg-primary text-white px-6 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-primary/20 flex items-center gap-2 hover:opacity-90 transition-opacity self-end">
          <Download size={18} />
          데이터 내보내기
        </button>
      </section>
